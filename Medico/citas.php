...
$resul=$obj->readOneByMedicoInOrden($_SESSION['usuario'],$fechaActual);
$tam=count($resul);
?>
<div class="container"> 
  <div class="row">
  ...
  <thead>
    ...
    <tr>
      ...
      <td><?php echo $resul[$i]['estado'];?></td>
       ...
       <?php
       if($fechaActual === $resul[$i]['fecha'] && $resul[$i]['estado']=='activo'){
       ?>
       <td><a href="http://localhost/clinicafinal/Medico/atender.php?idc=<?php echo $resul[$i]['id_cita'];?>&idp=<?php echo $resul[$i]['id_paciente'];?>"><img src="http://localhost/clinicafinal/imagenes/atend.png" alt="Editar" id="icono"></a></td>
       <td><a href="http://localhost/clinicafinal/Medico/editC.php?idc=<?php echo $resul[$i]['id_cita'];?>"><img src="http://localhost/clinicafinal/imagenes/calendar.png" alt="Editar" id="icono"></a></td>
