...
if(isset($_GET['idm'])){
$fac=new facade();
$resul=$fac->readMedicoById($_GET['idm']);
...
<h3 class="display-5" align="center">EDITAR CONTRASEÑA</h3>
            ...
            <button type="submit" value="EDITARC" name="EDITARM" class="btn btn-dark btn-lg btn-block" onclick="return validarEditPas();" >EDITAR CONTRASEÑA</button>
            </form>
            </div>
...
<?php
    ...
    header("Location: http://localhost/clinicafinal/medico/index.php");
}
}else{
