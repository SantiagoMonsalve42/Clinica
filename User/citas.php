...
$resul=$obj->readOneByPacienteInOrden($_SESSION['usuario'],$fechaActual);
$tam=count($resul);
?>
<div class="container"> 
  <div class="row">
  ...
  <div class="col-12 col-sm-12 col-xs-12 col-md-12 col-lg-2">
    ...
    <a href="http://localhost/clinicafinal/User/insertC.php" class="btn btn-dark ">Nueva cita</a>
    </div>
    </div>
  ...
  <thead>
    ...
    <tr>
      ...
      <td><a href="http://localhost/clinicafinal/User/editC.php?idc=<?php echo $resul[$i]['id_cita'];?>"><img src="http://localhost/clinicafinal/imagenes/calendar.png" alt="Editar" id="icono"></a></td>
      <td><a href="http://localhost/clinicafinal/app/logic4.php?idc=<?php echo $resul[$i]['id_cita'];?>&accion=delete"><img src="http://localhost/clinicafinal/imagenes/eliminar.png" alt="Editar" id="icono"></a></td>
    ...
    <?php  }
      ...
      <td colspan="7" style="text-align:center;">No tiene citas asignadas al momento..</td>
    
      <td><a href="#"><img src="http://localhost/clinicafinal/imagenes/atend.png" alt="Editar" id="icono"></a></td>
    <td><a href="#"><img src="http://localhost/clinicafinal/imagenes/calendar.png" alt="Editar" id="icono"></a></td>
