...
<h3 class="display-5" align="center">EDITAR DATOS PERSONALES</h3>
            ...
            <div class="form-row">
               ...
               <div class="form-group col-md-12">
                 <input type="text" id="nombre" value='<?php echo $resul[0]['nombres'];?>'name="nombre" class="form-control" placeholder="Primer nombre" readonly>
               </div>
               </div>
              <div class="form-row">
              <div class="form-group col-md-12">
              <input type="text" id="apellido" class="form-control" value='<?php echo $resul[0]['apellidos'];?>' placeholder="Primer apellido" name="apellido" readonly>
              </div>
              </div>
              <div class="form-row">
              <div class="form-group col-md-12">
              ...
              <div class="form-row">
              <div class="form-group col-md-12">
              <input type="date" id="fechanacimiento" class="form-control" value='<?php echo $resul[0]['fecha_nacimiento'];?>' name="fechanacimiento" readonly>
              </div>
              </div>        
