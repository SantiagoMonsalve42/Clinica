...
?>
            <form action="../app/logic2.php" method="post">
               <div class="form-row">
           ...
           <option value="<?php echo $resul1[$i]['id_medico'];?>"><?php echo $resul1[$i]['nombre'];?></option>
              ...
              <div class="form-row">
              <div class="form-group col-md-12">
              <select class="custom-select" id="idp" name="idp" required>
            <option value="0">USUARIOS</option>
              <?php
              for($i=0;$i<count($resul2);$i++){
                ?>
           <option value="<?php echo $resul2[$i]['id_paciente'];?>"><?php echo $resul2[$i]['id_paciente'];?></option>
              <?php
              }
              ?> 
            </select> 
