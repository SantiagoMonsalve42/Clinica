            ...
            <div class="form-row">
              <br><br>
               <div class="form-group col-md-12">
                <h6 class="display-5">Correo: <?php echo $resul[0]['correo'];?></h6>
               </div>
               </div>
              <div class="form-row">
              <div class="form-group col-md-12">
              ...
              <div class="form-row">
              <div class="form-group col-md-12">
              <input type="password" class="form-control" ip="pass2" name="pass2" placeholder="Verifique contraseña" required>
              </div>
              </div>
              <input type="hidden" name="idm" value='<?php echo $_GET['idm'];?>'>
            <button type="submit" value="EDITAR2" name="Smedico" class="btn btn-dark btn-lg btn-block"  onclick="return validarEditPas();">EDITAR CONTRASEÑA</button>
            </form>
            </div>
