...
<div class="container"> 
  ...
  <div class="jumbotron">
<h3 class="display-5" align="center">NUEVO MEDICO</h3>
            ...
            <div class="form-row">
              ...
              <div class="form-row">
              <div class="form-group col-md-12">
              <input type="text" class="form-control" id="papellido" placeholder="Primer apellido" name="papellido" required>
              </div>
              </div>
              <div class="form-row">
              <div class="form-group col-md-12">
              ...
              <div class="form-row">
              <div class="form-group col-md-12">
              <input type="number" class="form-control" id="telefono" name="telefono" min="3000000000" max="3999999999" placeholder="Telefono" required>
              </div>
              </div>
              <div class="form-row">
              <div class="form-group col-md-12">
            ...
            <div class="form-row">
            <div class="form-group col-md-12" >
            <input type="password" class="form-control" id="answer" name="answer" placeholder="Respuesta">
            </div>
            </div>
             <?php
            $objf = new facade();
            $resul=$objf->readAllEspecialidadDisponible();
            ?>
            <h5 align="left">Datos profesionales: </h5>
              <div class="form-row">
              <div class="form-group col-md-12" >
              
            <select class="custom-select" id="ask" name="especialidad" required>
            
            <?php  
            for ($i=0;$i<count($resul);$i++){?>
              <option value="<?php echo $resul[$i]['id_especialidad']; ?>"><?php echo $resul[$i]['nombre']; ?></option>
            <?php
            }
            ?>
            </select>
              ...
              if(isset($_GET['iderror'])){
                ...
                if($_GET['iderror'] == 'a'){
                 ...
                 if($_GET['iderror'] == '1'){
                  ?>
                  <p align="center" style="color:red;" >La especialidad ingresada ya existe</p>
                  <?php
                 }
                 if($_GET['iderror'] == '2'){
                  ?>
                  <p align="center" style="color:red;" >Las claves ingresadas no son iguales</p>
                  <?php
                 }
                 if($_GET['iderror'] == '3'){
                  ?>
                 ...
                 if($_GET['iderror'] == '4'){
                  ?>
                  <p align="center" style="color:red;" >Error operacional del sistema, vuelva a intentarlo</p>
                  <?php
                 }
                 if($_GET['iderror'] == '5'){
                  ?>
                 ...
                 if($_GET['iderror'] == '6'){
                  ?>
                  <p align="center" style="color:red;" >No selecciono una pregunta de seguridad valida</p>
                  <?php
                 }
                 if($_GET['iderror'] == '7'){
                  ?>
                  <p align="center" style="color:red;" >No selecciono un sexo valido</p>
                  <?php
                 }
                 if($_GET['iderror'] == '8'){
                  ?>
            ...
            <button type="submit" value="CREARM" name="Smedico"class="btn btn-success btn-lg btn-block" onclick="return validarInsertM();" >CREAR USUARIO</button>
            </form>
            </div>
